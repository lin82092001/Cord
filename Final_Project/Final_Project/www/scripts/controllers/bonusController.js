angular.module('Final_Project').controller('bonusController', function ($scope, $rootScope, $ionicSlideBoxDelegate,
    AccountManager, TransactionManager, CardProxy) {
    ...
    this.add = function () {
        ...
        CardProxy.addTransaction(self.account.id, parseInt(self.amount), function (transaction) {
